      ...
      <ContainerMain>
        ...
        <TitleWithComponent>
          ...
          <Grid $columns={2} $rows={1} $changeInScreenSize={1100} >
            <img style={{ width: '100%', height: '100%', objectFit: 'cover', maxHeight: '500px' }} src="https://curtamais.com.br/goiania/wp-content/uploads/sites/2/2020/07/d1e1482ea0b75a82c130e897c40dcc9a-1024x682.jpeg" alt="" />
            <Text>
